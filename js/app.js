...
const notificationButton = document.querySelector('.header--notification-btn');
...
const notificationCardCloseBtn = document.querySelector('.header--notification-dropdown-card-btn');
